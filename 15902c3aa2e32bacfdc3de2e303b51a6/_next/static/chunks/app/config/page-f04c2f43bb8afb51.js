...
var APPS=[{id:"aodb",name:"AODB"},{id:"ciss",name:"CiSS"},{id:"airside",name:"Airside"},{id:"acro",name:"ACRO"}];
...
(0,jsx.jsx)(Field,{label:"Baseline start",hint:"Anchors the planned duration used for the schedule percentage",children:(0,jsx.jsx)("input",{type:"date",value:config.baselineStart||"",onChange:function(e){commit({baselineStart:e.target.value})},className:"input"})}),(0,jsx.jsx)(Field,{label:"Target deadline",children:(0,jsx.jsx)("input",{type:"date",value:config.baselineDeadline,onChange:function(e){commit({baselineDeadline:e.target.value})},className:"input"})}),
...
seedRows("airside",[["1.1.0.1 - Assets - Register - Maintain","EI","Medium","Deployed"],["1.2.0.1 - Energy - Usage - Report","EO","Medium","Deployed"],["1.3.0.2 - Sensors - Reading - Import","EI","Low","Deployed"],["2.1.0.4 - Maintenance - Order - Create","EI","High","Tested"],["2.2.0.1 - Facilities - Booking - View","EQ","Low","DoD"],["3.0.0.1 - BIM - Model - File","ILF","High","DoR"],["3.1.0.0 - GIS - Layer - Interface","EIF","Medium","Open"],["3.2.0.2 - Compliance - Audit - Report","EO","Medium","Open","Changed",30]]),
